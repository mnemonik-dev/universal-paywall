...
| --- | --------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| 5   | Federated VOD         | [Chocobozzz/PeerTube](https://github.com/Chocobozzz/PeerTube) | plugin loader; [`req.rawBody` PR #6300](https://github.com/Chocobozzz/PeerTube/pull/6300) enabled Stripe-style webhooks; [#1586](https://github.com/Chocobozzz/PeerTube/issues/1586) 7-yr demand | **Plugin**                                    | Publish a `peertube-plugin-universal-paywall` to the plugin marketplace; on a view event, call the facilitator. _Not a core PR — a published plugin._ |
| 6   | Fediverse fundraising | [mastodon/mastodon](https://github.com/mastodon/mastodon)     | `GET /api/v1/donation_campaigns` ([#37880](https://github.com/mastodon/mastodon/pull/37880), merged)                                                                                             | **Provider**                                  | Run an external campaign-source service the instance points at. _Fills a sanctioned slot — no core PR._                                               |
...
1. **Permissionless is the article's whole point** — for #1–4 and #7 a PR is the _wrong_ shape; a sidecar attaches without touching upstream.
